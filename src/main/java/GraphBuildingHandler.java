...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private GraphDB.Node previousNode;
    private ArrayList<Long> currentIDs = new ArrayList<>();
...
//            System.out.println("Beginning a way...");
            ...
            Long n = Long.parseLong(attributes.getValue("ref"));
            currentIDs.add(n);
...
//            System.out.println("Tag with k=" + k + ", v=" + v + ".");
            ...
            String v = attributes.getValue("v");
            previousNode.setName(v);
            g.createLocation(previousNode, v);
            /* Hint: Since we found this <tag...> INSIDE a node, we should probably remember which
            node this tag belongs to. Remember XML is parsed top-to-bottom, so probably it's the
            last node that you looked at (check the first if-case). */
//            System.out.println("Node's name: " + attributes.getValue("v") + "\nPrevious Node's name: " + previousNode.id);
        }
    }
...
//            System.out.println("Finishing a way...");
            if(validWay) {
                for(int i = 1; i < currentIDs.size(); ++i) {
                    g.addEdge(currentIDs.get(i-1), currentIDs.get(i));
                }
            }
